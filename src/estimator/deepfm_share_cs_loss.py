...
class DeepFMSCSLOSS(BaseModel):
    def __init__(self, **params):
        super(DeepFMSCSLOSS, self).__init__(**params)
    ...
    def _forward(self, features, is_training):
        ...
        for embed_col in embed_column:
            ...
            embed_matrix = tf.get_variable(name=feature_name + '_embmatrix',
                                           shape=[len(vocabulary_list), self.embedding_size], initializer=t,
                                           trainable=True)
